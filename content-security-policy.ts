export function buildContentSecurityPolicy(
  ...
  const directives: string[] = [
    ...
    "connect-src 'self' https://api-maps.yandex.ru https://*.yandex.ru https://*.maps.yandex.net https://mc.yandex.ru wss://mc.yandex.ru wss://*.yandex.ru https://hdrc.yandex.net https://*.twcstorage.ru https://*.timeweb.cloud https://vk.com https://*.vk.com https://*.vkvideo.ru",
