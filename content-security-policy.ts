export function buildContentSecurityPolicy(
  ...
  const directives: string[] = [
    ...
    "img-src 'self' data: blob: https://*.twcstorage.ru https://*.timeweb.cloud https://*.yandex.ru https://*.maps.yandex.net https://hdrc.yandex.net https://yastatic.net https://*.vk.com https://*.vkuser.net https://*.userapi.com",
    ...
    "frame-src 'self' https://vk.com https://*.vk.com https://vkvideo.ru https://*.vkvideo.ru https://yandex.ru https://*.yandex.ru https://hdrc.yandex.net",
    "connect-src 'self' https://api-maps.yandex.ru https://*.yandex.ru https://yandex.ru https://*.maps.yandex.net https://mc.yandex.ru wss://mc.yandex.ru wss://*.yandex.ru https://hdrc.yandex.net https://*.twcstorage.ru https://*.timeweb.cloud https://vk.com https://*.vk.com https://*.vkvideo.ru",
